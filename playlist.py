...
add_song(my_playlist, {'artist':'Edward Sharpe & The Magnetic Zeroes', 'title':'Home'})
...
add_song(my_playlist, {'artist':'Lana Del Rey', 'title':'Gods & Monsters'})
add_song(my_playlist, {'artist':'Gordon Lightfoot', 'title':'The Wreck of the Edmund Fitzgerald'})
